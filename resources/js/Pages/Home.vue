        ...
        <div class="mx-auto lg:pl-0 md:pl-[80px] pl-0" >
            ...
            <Slide v-for="slide in 10" :key="slide">
                <Link href="/" class="relative mx-auto text-center mt-4 px-2 cursor-pointer">
                    ...
                    <img class="rounded-full w-[56px] h-[56px] -mt-[1px]" src="https://picsum.photos/id/200/300/320" alt="">
                    <div class="tetx-xs mt-2 w-[60px] truncate text-ellipsis overflow-hidden">NAME HERE</div>
                 </Link>
            </Slide>
