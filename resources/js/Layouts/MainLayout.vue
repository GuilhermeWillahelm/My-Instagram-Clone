...
<template>
    <div id="MainLayout" class="w-full h-screen">
                ...
                <div class="flex items-center w-[50%]">
                    <div class="flex items-center w-full bg-gray-100 rounded-lg">
                        ...
                        <input type="text" placeholder="Search"
                            class="bg-transparent w-full placeholder-[#8E8E8E] border-0 ring-0 focus:ring-0s">
                    </div>
        ...
        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            <Link href="/">
            <img class="xl:hidden block w-[25px] mt-10 ml-[25px] mb-10 cursor-ponter" src="/insta-logo-small.png" alt="">
            <img class="xl:block hidden w-[120px] mt-10 ml-6 mb-10 ml-[25px] mb-10 cursor-ponter" src="/insta-logo.png"
                alt="">
            </Link>
        ...
        <div class="flex lg:justify-between bg-white h-full w-[100%-280px] xl:pl-[280px] lg:pl-[100px] overflow-auto">
            ...
            <div v-if="$page.url === '/'" id="SuggestionsSection" class="lg:w-4/12 lg:block hidden text-black mt-10">
                ...
                <div class="max-w-[300px] flex items-center justify-between py-3">
                    ...
                    <button class="text-blue-500 hover:text-gray-900 text-us font-extrabold">
                        See All
                    </button>
                </div>
        ...
        <div id="BottomNav" class="fixed z-30 bottom-0 w-full md:hidden flex items-center justify-around bg-white border-t py-2 border-t-gray-300">
            ...
            <Compass fillColor="#000000" :size="33" class="cursir-pointer" />
            <SendOutline fillColor="#000000" :size="33" class="cursir-pointer" />
            <Plus @click="$event => showCreatePost = true" fillColor="#000000" :size="33" class="cursir-pointer" />
            <AccountOutline fillColor="#000000" :size="33" class="cursir-pointer" />
            <Link href="/">
